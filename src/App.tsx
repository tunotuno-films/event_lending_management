    ...
    <Router>
      <div>
        ...
        {(showAuthModal || !isAuthenticated) && !showWelcomeAnimation && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 sm:p-6 overflow-hidden">
                  ...
                  <div className="flex gap-4 pt-2">
                    ...
                    {isAuthenticated && (
                      <button
                        ...
                        className="flex-1 bg-gray-500 hover:bg-gray-600 text-white px-5 py-3 rounded-md text-base"
                      >
                        キャンセル
                      </button>
                    )}
