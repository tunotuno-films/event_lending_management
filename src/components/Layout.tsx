    ...
    return (
      <div className="min-h-screen bg-gray-100 flex flex-col">
        ...
        <div className="flex flex-1 overflow-hidden">
          {/* Desktop Sidebar：fixedで左に固定、overflow-y-auto を追加 */}
          <div className="hidden md:block fixed top-0 left-0 h-screen w-64 bg-white shadow-sm z-30 pt-20 overflow-y-auto">
          ...
          {/* Mobile Sidebar：overflow-y-auto を追加 */}
          <div className="md:hidden">
            <div className={`
              bg-white shadow-sm fixed inset-y-0 left-0 z-30 w-64 transform transition-transform duration-300 ease-in-out overflow-y-auto
