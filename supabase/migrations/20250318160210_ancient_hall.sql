...
DROP POLICY IF EXISTS "Enable read access for authenticated users" ON control;
DROP POLICY IF EXISTS "Enable insert access for authenticated users" ON control;
DROP POLICY IF EXISTS "Enable update access for authenticated users" ON control;
